...
public class JwtService {
    ...
    private static final String SECRET_KEY ="7EA6A355996CE23DE9A7D7F58F591"; //puede ir en el app properties
    ...
    public String generateToken (
        ...
        return Jwts.builder()
                ...
                .setSubject(userDetails.getUsername())// esto hay que adaptarlo a lo que haya creado fran
